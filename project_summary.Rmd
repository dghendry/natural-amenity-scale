...
We can do the same thing for all the counties in the US. Notes: (1) There are about 3,000 counties in the US. In total about 85,000 points go into creating the polygons for the map below. (2) Somehow during the rendering process in Rmd the map has become distorted - that needs to be corrected. (3) What do the grey counties mean?  Yes, data is missing or there is a bug in the data wrangling or data visualization code. There may be several reasons. More work would need to be carried out to get to the bottom of it.
