...
Recall the Natural Amenity Scale, ranging from 1 (low) to 7 (high), is a measure of the "beauty" of region. All counties in the USA have been assigned a rank on this 7-point scale.
...
We need, in short, a way to bridge the two tables. Here is such a bridging table. (I found it by doing a google search on "state name state code csv file" Credit: [World Population Review](http://worldpopulationreview.com/states/state-abbreviations/)). 
...
This new table, shown next, has the Natural Amenity Rank and the mapping data in the same table. Our data wrangling is done! (dyplr was used for all of this work.)
...
We can do the same thing for all the counties in the US. (A note: There are about 3,000 counties in the US. In total about 85,000 points go into creating the polygons for the map below.)
